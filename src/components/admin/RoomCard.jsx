...
function RoomCard({ room, onDelete }) { // Accept onDelete prop
  ...
  return (
    <div className="bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700 flex flex-col transform hover:scale-102 transition-all duration-300 ease-in-out">
      ...
      <div className="mt-auto flex justify-end space-x-3">
        <button
          onClick={() => navigate(`/admin/rooms/edit/${room._id}`)} // Navigate to edit route
        ...
        <button
          onClick={() => onDelete(room._id)} // Call onDelete prop with room ID
