  ...
  useEffect(() => {
    ...
    if (id) {
      const fetchEmployee = async () => {
        ...
        try {
          const res = await axios.get(`http://localhost:3000/api/epmloyee/${id}`, {
            headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (id) {
        ...
        res = await axios.put(`http://localhost:3000/api/epmloyee/${id}`, editPayload, {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
        ...
        res = await axios.post('http://localhost:3000/api/epmloyee', payload, {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
            'Content-Type': 'application/json',
          },
