  ...
  useEffect(() => {
    ...
    if (salaryId) { // Edit mode: fetch existing salary
      const fetchSalary = async () => {
        ...
        try {
          const res = await axios.get(`http://localhost:3000/api/salary/${salaryId}`, {
            headers: { Authorization: `Bearer ${jwtToken}` },
          });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (salaryId) {
        ...
        res = await axios.put(`http://localhost:3000/api/salary/${salaryId}`, editPayload, {
          headers: {
        ...
        res = await axios.post('http://localhost:3000/api/salary', payload, {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
            'Content-Type': 'application/json',
          },
