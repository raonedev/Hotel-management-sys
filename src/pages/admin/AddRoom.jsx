  ...
  useEffect(() => {
    ...
    if (roomId) {
      const fetchRoom = async () => {
        ...
        try {
          const res = await axios.get(`https://hotel-management-sys-backend.vercel.app/api/rooms/${roomId}`, {
            headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (roomId) {
        ...
        res = await axios.put(`https://hotel-management-sys-backend.vercel.app/api/rooms/${roomId}`, editPayload, {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
        ...
        res = await axios.post('https://hotel-management-sys-backend.vercel.app/api/rooms', payload, {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
            'Content-Type': 'application/json',
          },
